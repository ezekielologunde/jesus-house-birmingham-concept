...
//
// The "youth" description also draws on a web search (2026-08-26) confirming
// YAYA is RCCG's official worldwide "Young Adults and Youth Affairs" ministry
// structure, not just a local nickname — consistent themes (discipleship,
// mentorship, leadership development) appear across multiple real RCCG
// parishes' own public descriptions of their YAYA chapters. No JHB-specific
// programming beyond what the WhatsApp source already confirmed (fellowship,
// choir, YAYA Week) is asserted here.
...
export const ministries = [
  ...
  { id: "youth", name: "YAYA (Youths & Young Adults)", description: "Part of RCCG's worldwide Young Adults and Youth Affairs network — weekly fellowship, its own choir, mentorship and leadership development, and an annual YAYA Week every April." },
