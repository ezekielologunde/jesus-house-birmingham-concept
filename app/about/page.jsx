...
export default function About() {
  return (
    <main className="px-6 pt-32 pb-24 max-w-3xl mx-auto">
      ...
      <Reveal delay={80}>
        <h2 className="font-display text-2xl md:text-3xl tracking-tight mt-12 mb-3">Our Vision</h2>
        <p className="font-body text-ink/80">{siteInfo.vision}</p>
      </Reveal>

      <Reveal delay={80}>
        <h2 className="font-display text-2xl md:text-3xl tracking-tight mt-12 mb-3">Our Message</h2>
        <p className="font-body text-ink/80">{siteInfo.coreMessage}.</p>
      </Reveal>

      <Reveal delay={80}>
        <h2 className="font-display text-2xl md:text-3xl tracking-tight mt-12 mb-3">What We Believe</h2>
      ...
      <Reveal delay={80}>
        <h2 className="font-display text-2xl md:text-3xl tracking-tight mt-12 mb-3">Education</h2>
      ...
      <Reveal delay={80}>
        <h2 className="font-display text-2xl md:text-3xl tracking-tight mt-12 mb-3">Camp Development</h2>
        <p className="font-body text-ink/80">
