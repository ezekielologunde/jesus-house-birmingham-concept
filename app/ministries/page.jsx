...
export default function Ministries() {
  return (
    <main className="px-6 pt-32 pb-24 max-w-5xl mx-auto">
      <RevealText text="Ministries" tag="h1" className="font-display text-4xl md:text-5xl lg:text-6xl mb-4" />
      <Reveal delay={100}>
      ...
      <div className="grid gap-8 md:grid-cols-3">
        {ministries.map((m, i) => (
          <Reveal key={m.id} delay={i * 60}>
            <h2 className="font-display text-xl md:text-2xl mb-2">{m.name}</h2>
